...
import { Upload, ArrowLeft, Video, CheckCircle, AlertCircle } from 'lucide-react'
...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      console.log('Uploading:', { title, file: selectedFile })
    ...
    <div className='min-h-screen bg-background p-4'>
      <div className='max-w-2xl mx-auto'>
        <div className='mb-6'>
          ...
          <h1 className='text-3xl font-bold'>Subir Video</h1>
